...
public class Application4 {
    public static void main(String[] args) {
        ...
        *  - 객체 단위로 입출력하게 만드는 보조스크림 */

        MemberDTO[] outputMembers = {
                new MemberDTO("user01", "pass01", "홍길동", "hong@ohgiraffers.com", 25, '남', 1250.7),
                new MemberDTO("user02", "pass02", "유관순", "you@ohgiraffers.com", 16, '여', 1234.5),
                new MemberDTO("user03", "pass03", "권은지", "gee@ohgiraffers.com", 20, '여', 6789.1)
        };
        ...
        /* NotSerializableException : 직렬화 처리를 해주지 않아서 발생하는 에러
        *  직렬화 : 자바 시스템 내부에서 사용되는 객체 또는 데이터를 외부에서도 사용할 수 있도록 byte 형태로 변환하는 기술
