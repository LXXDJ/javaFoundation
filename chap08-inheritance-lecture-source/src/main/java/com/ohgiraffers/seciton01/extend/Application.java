...
public class Application {
    ...
    *
    *  [상속의 단점]
    *  1. 부모클래스의 기능을 추가/변경 할 경우 자식클래스가 정상 동작하는지 예측이 어렵다.
    *     상속 구조가 복잡해질수록 그 영향에 대한 예측이 힘들며
