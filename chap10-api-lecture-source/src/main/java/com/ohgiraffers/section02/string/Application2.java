...
public class Application2 {
    public static void main(String[] args) {
        ...
        *  new String("문자열") : 매번 새로운 인스턴스를 생성 */
        ...
        /* 동일한 문자열은 동일한 해시코드 값을 반환하도록 재정의되어 있다. */
        ...
        /* 문자열은 불변이라는 특징을 가진다.
        *  기존 문자열에 + 연산을 수행하는 경우, 문자열 수정이 아니라 새로운 문자열을 할당하게 된다. */
        str2 += "oracle";
        System.out.println("str1 == str2 : " + (str1 == str2));   // false

        /* String 클래스의 equals() : 인스턴스 비교가 아닌 문자열값을 비교하여
        *  동일한 값인 경우 true, 아니면 false 반환하도록 Object의 equals() 메소드를 이미 재정의 해두었다.
        ...
        *  구분하기 힘들면 그냥 문자열은 equals() 비교하는 것이 가장 좋은 방법이다. */
    }
}
