...
public class Application2 {
    public static void main(String[] args) {
        ...
        /* 필기. 수학적으로 사용하는 사칙연산에 추가로 나머지를 구하는 연산(mod)를 사용할 수 있다. */
        ...
        /* 필기. 실수끼리의 연산도 수학에서 사용하는 사칙연사에 나머지를 구하는 연산(mod)를 사용할 수 있다. */
        System.out.println("==== 실수와 실수의 연산 ====");
        System.out.println(1.23 + 1.23);
        System.out.println(1.23 - 0.23);
        System.out.println(1.23 * 10.0);
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0);     // 약간의 오차 발생
        ...
        /* 필기. 문자열과 문자열의 '+' 연산결과는 문자열 합치기(이어 붙이기)가 된다. */
        /* 필기. 문자열은 '+' 연산 외에 다른 연사을 사용하지 못한다. */
