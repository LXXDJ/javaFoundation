...
public class Application3 {
    public static void main(String[] args) {
        ...
        System.out.println("10과 20의 합 : " + (10 + 20));     // 괄호를 묶지 않으면 문자열 합치기가 발생하여 결과가 1020이 된다.
        System.out.println("10과 20의 차 : " + (10 - 20));     // 문자열은 마이너스 연산 불가. (반드시 괄호 필요)
