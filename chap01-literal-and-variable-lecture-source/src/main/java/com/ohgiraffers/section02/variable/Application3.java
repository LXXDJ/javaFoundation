...
//        int sh@rp = 20;   // 사용 가능한 특수문자 외에는 사용 불가능
        ...
        /* 필기. 단어와 단어 사이의 연결을 언더스코어(_)로 하지 않는다. */
        String user_name;
        String usrName;     // 올바른 표현
