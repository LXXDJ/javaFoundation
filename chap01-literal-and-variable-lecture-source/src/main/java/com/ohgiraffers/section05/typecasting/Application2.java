...
public class Application2 {
    public static void main(String[] args) {
        ...
        *  */
        ...
        /* 필기.
        *  자동형변환 규치그이 반대 상황에서 강제 형변환이 필요하다.
        *  1. 강제 형변환 규칙
...
//        long lnum2 = fnum2;       // float는 4byte, long은 8byte임에도 자동 형변환 불가능 (소수점 이하 데이터 손실 가능성)
        long lnum2 = (long)fnum2;   // 강제 형변화의 의미는 '내가 데이터 손실을 감안할테니 형변환 해줘'라는 의미

        System.out.println(fnum2);
        System.out.println(lnum2);

        /* 필기. 문자형을 int 미만 크기의 변수에 저장할 때 강제 형변환 필요 */
        char ch = 'a';
        byte bnum2 = (byte) ch;     // 당연히 char 자료형보다 작은 크기이니 강제형변환을 해야 한다.
        short snum2 = (short) ch;   // 같은 2byte지만 부호비트(sign bit)로 인한 값의 번위가 다르기 때문이다.
