...
public class User {
    ...
    *  2. 매개변수가 있는 생성자의 경우 매개변수로 전달받은 값으로 필드가 초기화되며, 인스턴스를 생성할 목적으로 주로 사용
    ...
    *  기본생성자가 필요한 경우에는 반드시 명시적으로 작성해 주어야 한다.*/
    ...
    /* 동일한 이름의 생성자 혹은 메소드를 한 클래스 안에서 작성 불가 (Compiler Error) */
//    public User(){}
    ...
    public User(String id, String pwd, String name){
        ...
        System.out.println("User 클래스의 id, pwd, name 초기화하는 생성자 호출");
    }
...
//        this.enrollDate = enrollDate;
        ...
        *  this()는 가장 첫 줄에 선언해야 하며, 그렇지 않은 경우 Compiler Error가 발생
        *  */
