...
public class Application {
    public static void main(String[] args) {
        ...
        *  5. 가변 인자 */
        ...
        System.out.print("기본자료형 배열 전달인자로 전달하는 값 : " + iarr);
...
//        pt.variableLengthArrayparameter();  // 인자가 아무것도 없는 경우 에러발생
        ...
        pt.variableLengthArrayparameter("유승제", new String[]{"테니스", "서예","탁구"}); // 배열형태도 가능
