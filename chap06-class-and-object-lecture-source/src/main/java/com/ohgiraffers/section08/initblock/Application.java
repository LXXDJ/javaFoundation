...
public class Application {
    public static void main(String[] args) {
        ...
        *     인스턴스 변수를 초기화하며 정적(static)필드에는 실행 시점마다 값을 덮어쓴다.
        *  {
        *       초기화 내용 작성
        *  }
        *
        ...
        *  */
        ...
        /* 매개변수가 있는 생성자를 이용한 초기화 확인 */
        Product product2 = new Product("캐모마일차", 4200, "투썸");
        System.out.println(product2.getInfo());

        /* 여기서 알수 있는 초기화 순서
        *  인스턴스(non-static)변수 : 기본값 > 명시적초기값 > 인스턴스초기화블럭 > 생성자
        *  클래스(static)변수 : 기본값 > 명시적초기값 > 정적초기화블럭 > 인스턴스초기화블럭 > 생성자 */
