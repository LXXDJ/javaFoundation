...
public class Application {
    ...
    *  2. 게으른 초기화 (Lazy Initialization) */
    ...
    public static void main(String[] args) {
        ...
        /* 이른 초기화 구현
        *  생성자를 이용하여 인스턴스 생성을 하지 못하고 getInstance() 메소드를 호출해야만 인스턴스 생성 가능 */
//    EagerSingleton eager = new EagerSingleton();    // 생성자가 private 이라서 접근 불가
